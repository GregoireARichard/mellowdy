 ...
 */
final class Version20211124140847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE send_email (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, notion_page_id INT NOT NULL, INDEX IDX_8EF07932A76ED395 (user_id), INDEX IDX_8EF079321ACAE608 (notion_page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
